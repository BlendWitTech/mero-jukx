...
export default function MeroHrSidebar({
    appSlug,
    collapsed,
    onToggle,
    buildHref,
    ...
    const handleLogoutAuth = async () => {
        try {
            ...
            toast.success('Logged out from Mero HR');
        } catch (error) {
        ...
        >
            ...
            >
                {!collapsed ? (
                    ...
                    >
                        <Users2 className="h-5 w-5" style={{ color: theme.colors.primary }} />
                    </button>
                )}
            </div>
